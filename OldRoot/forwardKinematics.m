...
%             obj.coord1_func = matlabFunction(coord1);
            obj.coord2_func = matlabFunction(coord2);
            obj.coord3_func = matlabFunction(coord3);
            obj.coord4_func = matlabFunction(coord4);
            obj.coordE_func = matlabFunction(coordE);
        ...
        function [x,y,z,theta] = getPose(obj,q1,q2,q3,q4,q5)
            coords = obj.coordE_func(q1,q2,q3,q4);
            x = coords(1);
            y = coords(2); 
            z = coords(3);
            theta = q5+q1;
        ...
        function [x,y,z] = findCoordinates(obj,q1,q2,q3,q4,q5)
            ...
            coord1 = obj.r01_0;
            coord2 = obj.coord2_func();
            coord3 = obj.coord3_func(q1,q2); 
            coord4 = obj.coord4_func(q1,q2,q3);
            coordE = obj.coordE_func(q1,q2,q3,q4);

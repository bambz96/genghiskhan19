...
void readQ(Q_t *Q, dynamixel::GroupSyncRead *groupSyncRead430, dynamixel::GroupSyncRead *groupSyncRead320, dynamixel::PacketHandler *packetHandler){
  ...
  Q->q1 = convertToRadians430(q1_encoder, false, Q1_SCALE, Q1_OFFSET);
  Q->q2 = convertToRadians430(q2_encoder, true,  Q2_SCALE, Q2_OFFSET);
  Q->q3 = convertToRadians430(q3_encoder, true,  Q3_SCALE, Q3_OFFSET);
  Q->q4 = convertToRadians320(q4_encoder, false, Q4_SCALE, Q4_OFFSET);
  Q->q5 = convertToRadians320(q5_encoder, false, Q5_SCALE, Q5_OFFSET);
  Q->q6 = convertToRadians320(q6_encoder, false, Q6_SCALE, Q6_OFFSET);
...
void writeQ(Q_t *Q, dynamixel::GroupSyncWrite *groupSyncWrite430, dynamixel::GroupSyncWrite *groupSyncWrite320,  dynamixel::PacketHandler *packetHandler) {
  ...
  int q1 = convertToPositionCommand430(Q->q1, false, Q1_SCALE, Q1_OFFSET);
  int q2 = convertToPositionCommand430(Q->q2, true, Q2_SCALE, Q2_OFFSET);
  int q3 = convertToPositionCommand430(Q->q3, true, Q3_SCALE, Q3_OFFSET);
  int q4 = convertToPositionCommand320(Q->q4, false, Q4_SCALE, Q4_OFFSET);
  int q5 = convertToPositionCommand320(Q->q5, false, Q5_SCALE, Q5_OFFSET);
  int q6 = convertToPositionCommand320(Q->q6, false, Q6_SCALE, Q6_OFFSET);
